...
print(connected_ips-blacklisted_ips)

blacklisted_ips.add("10.0.0.9")

for i in (connected_ips):
    if i in blacklisted_ips:
        print(f"ALERT: Blocked IP detected:{i}")

print(connected_ips.union(blacklisted_ips))
...
# ALERT: Blocked IP detected:10.0.0.2
# {'10.0.0.8', '10.0.0.9', '10.0.0.1', '10.0.0.2', '10.0.0.10', '10.0.0.5'}