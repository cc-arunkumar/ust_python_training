...
# Step 1: Read and display all rows
...
# Step 2: Display patients with required fields
with open("ust_healthcare_visit2.csv", "r") as file:
    reader = csv.DictReader(file)
    print("\nPatients with their important data...")
    for row in reader:
        required_fields = ['patient_id', 'name', 'visit_date', 'billed_amount', 'payment_status', 'insurance_provider']
...
with open("ust_healthcare_visit2.csv", "r") as file:
    ...
    for row in reader:
        ...
        row['follow_up_required'] = "Yes" if row['follow_up_required'] == '1' else "No"
...
# Step 4: Generate pending payments file
with open("ust_healthcare_visits.csv", "r") as file:
    ...
    with open("pending_payments.csv", "w", newline="") as file1:
        ...
        for row in reader:
            if row['payment_status'].strip().lower() != 'paid':
                clean_row = {key: row[key] for key in header if key in row}
...
with open("ust_healthcare_visits.csv", "r") as file:
    ...
    for row in reader:
        ...
        pid = row['patient_id']
        name = row['name']
        unpaid = 'Yes' if row['payment_status'].strip().lower() != 'paid' else 'No'

        if pid in summary:
            summary[pid][1] += 1
            summary[pid][2] += billed
            summary[pid][3] = unpaid
        else:
            summary[pid] = [name, 1, billed, unpaid]

with open("patient_summary.csv", "w", newline='') as file:
    writer = csv.writer(file)
    writer.writerow(["patient_id", "name", "visit_count", "total_billed", "has_pending_payment"])
    for pid, data in summary.items():
        writer.writerow([pid] + data)
...
# PS C:\Users\Administrator\Desktop\Training\ust_python_training\vinutha\day6> & "C:/Program Files/Python314/python.exe" c:/Users/Administrator/Desktop/Training/ust_python_training/vinutha/day6/task41.py
...
# ['P002', 'Riya Sharma', '02-10-2025', 'Orthopedics', '12000.00 ', 'HealthPlus', ' pending ', '9810098765', 'No']['P003', ' ', '2025/10/02', 'Neurology', '3500.00', '', 'Unpaid', '8800123456', 'No']
...
# ['P021', 'Lina Gomez', '2025-10-11', 'ENT', '2500.00', 'MedSecure', 'Pending', '7700097777', '1']
# ['P022', 'Tom Hanks', '2025-10-12', 'Neurology', '5000.00', '', 'Unpaid', '8800088888', 'No']
...
# ['P025', 'Emily Stone', '2025-10-13', 'Pediatrics', '900.00', 'ChildCare', 'Paid', '7000011111', 'No']
...
# ['P045', 'Noah Brown', '2025-10-21', 'Pediatrics', '2000.00', 'ChildCare', 'Paid', '7700047777', '0']
...
# ['P050', 'Eva Green', '2025-10-23', 'Oncology', '28000.00', 'CancerCover', 'Paid', '7700055555', 'Yes']
...
# ['P066', 'Hannah Wells', '2025-10-28', 'ENT', '2700.00', 'MedSecure', 'Paid', '7700024444', 'No']
# ['P067', 'Victor Cruz', '2025-10-29', 'Orthopedics', '6400.00', 'HealthPlus', ' pending ', '7000077777', 'YES'] 
...
# ['P084', 'Imelda Marcos', '2025-11-04', 'General Medicine', '1500.00', 'HealthPlus', 'Paid', '7700069999', 'No']['P085', 'Diego Rivera', '2025-11-04', 'Cardiology', '15500.00', 'MedSecure', 'unpaid', '8800007777', 'Yes']    
# ['P086', 'Aisha Siddiqui', '2025-11-05', 'ENT', '2400.00', 'MedSecure', 'Pending', '9810077777', 'No']
...
# ['P037', 'Igor Petrov', '2025-10-19', 'Oncology', '52000.00', 'CancerCover', 'PAID', '7700090000', 'YES']       
# ['P026', 'Victor Hugo', '2025-10-13', 'Cardiology', '9800.75', 'MedSecure', 'Pending', '7700044444', 'Yes']     
# ['P002', 'Riya Sharma', '02-10-2025', 'Orthopedics', '12000.00 ', 'HealthPlus', ' pending ', '9810098765', 'No']['P049', 'Manish Malhotra', '2025-10-23', 'Cardiology', '12500.00', 'MedSecure', 'Unpaid', '9900091111', 'Yes'] 
# ['P093', 'Raj Malhotra', '2025-11-07', 'ENT', '2500.00', 'MedSecure', 'Pending', '7700010001', 'No']
# ['P065', 'Marcus Aurelius', '2025-10-28', 'Oncology', '34000.00', 'CancerCover', 'Unpaid', '9990022222', 'Yes'] 
# ['P008', 'Li Wei', '2025-10-05', 'Oncology', '45000.00', 'CancerCover', 'paid ', '6000012345', 'Yes']
# ['P090', 'Molly Ringwald', '2025-11-06', 'Pediatrics', '1100.00', 'ChildCare', 'UnPaid', '7700041111', 'No']    
...
# Patients with their important data...
# P001  Arun Kumar  2025-10-01 7500.00 Paid
