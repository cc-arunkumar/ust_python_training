...
#         """
#         headers = ["book_id","title","authors","isbn","tags","total_copies","available_copies"]
#         self._save("library_management_assessment/data/books(in).csv", headers, books)
...
#         """
#         headers = ["user_id","name","email","status","max_loans"]
#         self._save("library_management_assessment/data/users(in).csv", headers, users)
...
#         """
#         Save all Transaction objects to transactions.csv.
#         Overwrites the file with the current list of transactions.
#         """
#         headers = ["tx_id","book_id","user_id","borrow_date","due_date","return_date","status"]
#         self._save("library_management_assessment/data/transactions(in).csv", headers, txs)
