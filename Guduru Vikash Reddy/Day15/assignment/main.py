...
# Step 2: Define Pydantic models for validation and structure
...
# Step 3: Create sample data and store in dictionary
data={
 "employee": {
 "emp_id": 12345,
 "name": "Asha",
...
# Step 4: Define CRUD endpoints (Create, Read, Update, Delete)
...
# Step 5: Add search functionality with filters
