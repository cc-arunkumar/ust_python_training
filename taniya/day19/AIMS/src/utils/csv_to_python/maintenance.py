...
input_file = r"C:\Users\Administrator\Desktop\Training\ust_python_training\taniya\day19\AIMS\database\sample_data\maintenance_log(in).csv"  # Input file path
output_file = r"C:\Users\Administrator\Desktop\Training\ust_python_training\taniya\day19\AIMS\database\sample_data\final\validated_maintenance_log(in).csv"  # Output file path
