...
input_file = r'C:\Users\Administrator\Desktop\Training\ust_python_training\taniya\day19\AIMS\database\sample_data\vendor_master(in).csv'  # Input CSV file path
output_file = r'C:\Users\Administrator\Desktop\Training\ust_python_training\taniya\day19\AIMS\database\sample_data\final\validated_vendor_master(in).csv'  # Output CSV file path
