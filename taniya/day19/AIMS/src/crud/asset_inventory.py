...
def create_task(asset_id, asset_tag, asset_type, serial_number, manufacturer, model,
    ...
    try:
        ...
        sql = """
        INSERT INTO ust_aims.asset_inventory (
...
def get_task():
    try:
        ...
        sql = "SELECT * FROM ust_aims.asset_inventory"  # SQL query to fetch all assets
...
def get_task_by_id(asset_id: int):
    ...
    try:
        ...
        sql = "SELECT * FROM ust_aims.asset_inventory WHERE asset_id = %s"  # Query with placeholder
...
def get_assets_by_status(status: str):
    ...
    try:
        ...
        sql = "SELECT * FROM ust_aims.asset_inventory WHERE asset_status = %s"
...
def search_assets_by_column(column_name: str, value: str):
    ...
    try:
        ...
        sql = f"SELECT * FROM ust_aims.asset_inventory WHERE {column_name} = %s"
...
def count_assets():
    ...
    try:
        conn = get_connection()
        cursor = conn.cursor()
        sql = "SELECT COUNT(*) FROM ust_aims.asset_inventory"  # Count query
        cursor.execute(sql)
...
def update_asset(asset_id, asset_tag, asset_type, serial_number, manufacturer, model,
    ...
    try:
        ...
        sql = """
        UPDATE ust_aims.asset_inventory
...
def update_asset_status(asset_id, asset_status):
    ...
    try:
        ...
        sql = "UPDATE ust_aims.asset_inventory SET asset_status=%s WHERE asset_id=%s"
...
def delete_asset(asset_id):
    ...
    try:
        ...
        sql = "DELETE FROM ust_aims.asset_inventory WHERE asset_id=%s"
