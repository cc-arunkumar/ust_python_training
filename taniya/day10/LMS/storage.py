...
class CSVStorage:
    def __init__(self):
        ...
        # Ensure each CSV file exists with headers
    ...
    def load_books(self) -> List[Book]:
        ...
        try:
            with open(BOOKS_CSV, "r", newline="", encoding="utf-8") as f:
                ...
                for row in r:
                    try:
                        ...
                        if not b.book_id:  # Skip invalid rows
                            continue
                        books.append(b)
                    except Exception:
            ...
            # Ensure file exists with headers if missing
            self._ensure_file(BOOKS_CSV, BOOK_HEADERS)
        return books
    ...
    def save_books(self, list_of_books: List[Book]):
        ...
        # Rewrite file to ensure consistency
            ...
            with open(USERS_CSV, "r", newline="", encoding="utf-8") as f:
                ...
                for row in r:
                    try:
                        ...
                        if not u.user_id:  # Skip invalid rows
                            continue
                        users.append(u)
                    except Exception:
                        continue
    ...
    def save_users(self, list_of_users: List[User]):
        # Save list of users to CSV file
    ...
    def load_transactions(self) -> List[Transaction]:
        ...
        try:
            with open(TX_CSV, "r", newline="", encoding="utf-8") as f:
                r = csv.DictReader(f)
                # Iterate through rows and validate required fields
                for row in r:
                    try:
