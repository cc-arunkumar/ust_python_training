...
import { Users, Plus, Edit, Trash2, Search, UserCog, Mail, Briefcase, Shield } from 'lucide-react';
  ...
  const fetchUserRoles = async () => {
    try {
      ...
      if (userData && Array.isArray(userData.role)) {
        const roles = userData.role.filter((r) => ['admin', 'manager'].includes(r));
        setUserRoles(roles);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-700 font-semibold text-lg">Loading employees...</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all transform hover:scale-105">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-purple-100 text-sm font-medium mb-1">Your Role</p>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-gray-800 font-semibold">{emp.name}</span>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2 text-gray-600">
                          ...
                          <span>{emp.designation || emp.position || 'N/A'}</span>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <span
                          ...
                          {currentView === 'admin' && (
                            <>
                              <button
                                ...
                                className="p-2 rounded-xl hover:bg-purple-100 text-purple-600 transition-all hover:scale-110 shadow-sm hover:shadow-md"
                                title="Change Role"
                              >
                                <UserCog size={18} />
                              </button>
