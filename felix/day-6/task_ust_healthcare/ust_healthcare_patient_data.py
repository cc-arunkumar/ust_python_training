    ...
    for j in required_items:
        ...
        try:
            ...
            if(len(str(item[j]).strip())>0 and  float(item["billed_amount"])):
                ...
                count["skipped"]+=1
                return False,f"{j} not found"
        except ValueError:
            count["skipped"]+=1
            return False,f"Cannot convert bill value into float"
...
#Read main csv file
with open("ust_healthcare_visits (1).csv","r") as file1:
    ...
    for i in all_data:
        ...
        if(con and l==len(i.keys())):
            ...
            if(stmt!="Row Processed"):
                ...
                print("Skipped: Extra field for row")
                count["skipped"]+=1
                count["processed"]-=1
...
with open("pending_payments.csv","w",newline="") as file2:
    if clean_data:
        ...
        print("Pending Payments generated...")
...
print(f"Total data checked: {count['total']}") 


# output

# Skipped: name not found
# Skipped: patient_id not found
# Skipped: Cannot convert bill value into float
# Skipped: Cannot convert bill value into float
# Skipped: visit_date not found
# Skipped: Cannot convert bill value into float
# Skipped: Cannot convert bill value into float
# Skipped: Extra field for row
# Skipped: Cannot convert bill value into float
# Data cleaned...
# Pending Payments generated...
# Patient Summary generated...
# Processed data : 101
# Skipped data : 9
# Total data checked: 110