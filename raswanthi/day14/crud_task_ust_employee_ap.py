...
employees = [
    { "id": 1, "name": "Asha Rao", "email": "asha.rao@example.com", "department": "Engineering", "role": "Engineer", "status": "active" },
    { "id": 2, "name": "Vikram S", "email": "vikram.s@example.com", "department": "Delivery", "role": "Manager", "status": "active" },
    { "id": 3, "name": "Meera N", "email": "meera.n@example.com", "department": "HR", "role": "HR", "status": "active" }
]
