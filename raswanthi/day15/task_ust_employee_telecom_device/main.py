# assignment UST Employee Telecom management
...
class DataPlan(BaseModel):
    ...
    is_roaming_included: bool = Field(False)  
...
async def create_minimal_profile(profile: EmployeeTelecomProfile):
    # Default values are set in the model itself, so no further changes are needed
