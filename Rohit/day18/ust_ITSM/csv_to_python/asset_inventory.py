...
allowed_manufacturers = {"Dell", "HP", "Samsung", "Lenovo"}  # Valid manufacturers
allowed_conditions = {"New", "Good", "Used", "Damaged"}  # Valid condition statuses
allowed_locations = {"TVM", "Chennai", "Hyderabad", "Bangalore"}  # Valid office locations
allowed_status = {"Available", "Assigned", "Repair", "Retired"}  # Valid asset statuses

# File paths for input and output CSV files
input_file = r"C:\Users\Administrator\Desktop\ust_python_training\Rohit\day18\ust_ITSM\data\asset_inventory(in).csv"  # Input file path
output_file = r"C:\Users\Administrator\Desktop\ust_python_training\Rohit\day18\ust_ITSM\data\new_inventory.csv"  # Output file path
