...
input_file = r"C:\Users\Administrator\Desktop\ust_python_training\Rohit\day18\ust_ITSM\data\employee_directory(in).csv"  # Input file path
output_file = r"C:\Users\Administrator\Desktop\ust_python_training\Rohit\day18\ust_ITSM\data\new_employee_directory(validated).csv"  # Output file path
