...
# -----------------------------
# NOTE FROM USER:
# "starts with n 0-9, one special, one -, one upper, one lower"
# -----------------------------
# This looks like a requirement for a password or ID format:
# - Must start with a number (0-9)
# - Must contain at least one special character
# - Must contain at least one dash ("-")
# - Must contain at least one uppercase letter
# - Must contain at least one lowercase letter
#
# Example regex for such a rule could be:
# r"^(?=.*[0-9])(?=.*[A-Z])(?=.*[a-z])(?=.*[-])(?=.*[!@#$%^&*])[0-9].+$"
#
# You can add another @field_validator to enforce this rule on a chosen field (like asset_tag or a password field).
