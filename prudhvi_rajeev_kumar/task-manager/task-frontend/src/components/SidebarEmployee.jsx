...
import { FiClipboard, FiLayout, FiLogOut, FiChevronLeft } from "react-icons/fi";
...
const SidebarEmployee = () => {
  ...
  useEffect(() => {
    const init = async () => {
      ...
      const image = "https://img.freepik.com/premium-photo/3d-cartoon-avatar_113255-5627.jpg";
  ...
  const navItems = [
    { to: "/employee/tasks", label: "My Tasks", icon: <FiClipboard /> },
    { to: "/employee/kanban", label: "Kanban Board", icon: <FiLayout /> },
  ];
          ...
          <div className="flex items-center gap-3">
            ...
            {!collapsed && (
              <div>
                ...
                <div className="text-xs text-gray-400">Employee Console</div>
              </div>
            )}
          </div>
