...
#Sample Executions
# All Unique Emails:  {'meena@ust.com', 'priya@ust.com', 'rahul@ust.com', 'neha@ust.com', 'amit@ust.com', 'john@ust.com'}
# Common Customers:  {'amit@ust.com', 'priya@ust.com'}
# Only Campaign A:  {'rahul@ust.com', 'john@ust.com'}
# Only One Campaign: {'meena@ust.com', 'rahul@ust.com', 'neha@ust.com', 'john@ust.com'}
# Total Unique:  6