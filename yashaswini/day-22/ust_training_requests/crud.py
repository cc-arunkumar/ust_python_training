...
from ust_training_requests.models import TrainingRequestCreate, TrainingRequestOut  # Import Pydantic models for validation
from ust_training_requests.db_connection import get_db_connection  # Import helper function for DB connection
