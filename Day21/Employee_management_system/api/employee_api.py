...
from crud.employee_crud import create_employee,get_employee_by_id,update_employee_by_id,delete_employee_by_id
...
def create(emp:EmployeeModel):
    return create_employee(emp.first_name,emp.last_name,emp.email,emp.position,emp.salary,emp.hire_date)
