import os
import csv
from src.models.asset_model import AssetCreate
from src.models.employee_model import EmployeeCreate
from src.models.maientenance_model import MaintenanceCreate
from src.models.vendor_model import VendorCreate

# Define the root directory of your project (you can adjust this to match the actual path)
root_dir = r"D:\training\ust_python_training\deva_prasath\day_20\AIIMS_Plus\database\sample_data"

# Dictionary to store the relative file names and the model classes
file_info = {
    "asset": {
        "input_filename": "asset_inventory.csv",
        "output_filename": "validated_asset.csv",
        "model": AssetCreate
    },
    "employee": {
        "input_filename": "employee_directory.csv",
        "output_filename": "validated_employee.csv",
        "model": EmployeeCreate
    },
    "maintenance": {
        "input_filename": "maintenance_log.csv",
        "output_filename": "validated_maintenance.csv",
        "model": MaintenanceCreate
    },
    "vendor": {
        "input_filename": "vendor_master.csv",
        "output_filename": "validated_vendor.csv",
        "model": VendorCreate
    }
}
