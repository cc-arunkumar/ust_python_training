...
from src.api.maientenance_api import maintenance_router  # Import the maintenance router
...
from src.api.auth_login import jwt_router as auth_router  # Import the auth router

# Create FastAPI app instance
app = FastAPI(
    title="AIIMS Plus - Asset Inventory Management System"  # Set the API title
)
