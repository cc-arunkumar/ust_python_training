# Updated Pydantic Models (add 'in_review' to allowed statuses)
...
class TaskBase(BaseModel):
    ...
    status: str = Field(..., max_length=20, description="Status: pending, in_progress, in_review, completed")
    ...
    def validate_status(cls, v: str) -> str:
        allowed = ['pending', 'in_progress', 'in_review', 'completed', 'on_hold', 'cancelled']  # Added 'in_review'
        if v.lower() not in allowed:
