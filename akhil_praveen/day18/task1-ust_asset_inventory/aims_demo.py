...
data=[('UST-LTP-0001', 'Laptop', 'SN-DL-9988123', 'Dell', 'Latitude 5520', '2023-01-15', 3, None, 'Available'),
...
# for asset in data:
#     asset_crud.create_asset(asset)
print("---------------Read all asset ------------------")
asset_crud.read_all_asset()
print("---------------Read all asset where status is Available ------------------")
asset_crud.read_all_asset("Available")
print("---------------Read asset by id ------------------")
