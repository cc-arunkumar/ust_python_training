...
def get_vendors(status_filter: Optional[str] = "",current_user:User = Depends(get_curr_user)):
    try:
...
def get_vendor_by_id(vendor_id: int,current_user:User = Depends(get_curr_user)):
    try:
...
def create_vendor(new_vendor: VendorModel,current_user:User = Depends(get_curr_user)):
    try:
...
def update_vendor_details(vendor_id: int, update_vendor: VendorModel,current_user:User = Depends(get_curr_user)):
    try:
...
def delete_vendor_by_id(vendor_id: int,current_user:User = Depends(get_curr_user)):
    try:
...
def update_vendor_status(vendor_id: int, status: str,current_user:User = Depends(get_curr_user)):
    try:
