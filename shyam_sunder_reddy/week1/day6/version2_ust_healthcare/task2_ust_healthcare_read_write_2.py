...
with open("ust_healthcare_visits2.csv","r") as file:
...
with open("pending_payments2.csv",mode="w",newline="") as appendfile:
...
with open("patient_summary2.csv",mode="w",newline="") as summaryfile:
