...
@app.get("/user/{id}")
def userdetails(id:int,city:str="Hyderabad"):
    return {"the user details are":f"{id} and {city}"}
# {
#   "the user details are": "24 and Hyderabad"
# }
...
@app.get("/fullname")
def fullname(first:str="shyam",last:str="sunder"):
    return {"full name":f"{first},{last}"}
# {
#   "full name": "shyam,sunder"
# }
