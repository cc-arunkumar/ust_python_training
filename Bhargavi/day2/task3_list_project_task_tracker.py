...
# Find the index of "Testing" and insert "Client Review" right after it
...
# Remove "Deployment" from the main list
tasks.remove("Deployment")

# Print backup list (unchanged)
print("Backup list (unchanged):", backup_tasks)

# Print main list after removal
