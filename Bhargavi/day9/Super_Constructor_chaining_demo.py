...
class Developer(Employee):
    ...
    # Override method to describe developer's specific task
    def perform_task(self):
...
## Loop through each employee and call their perform_task method
for e in emp_list:
    e.perform_task()
