#Adding more attributes fro the same class by methods
# This program shows how methods can dynamically add new attributes to objects of the same class. 
# Using __dict__, we can view all attributes, including those added later through methods.
...
c1 = Car("tata","USA")
print("Car1:")
c1.accessories1("cool","plesent","good")# Adding accessories using accessories1()
print(c1. __dict__ )
