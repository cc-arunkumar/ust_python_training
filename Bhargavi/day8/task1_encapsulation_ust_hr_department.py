...
class Employeee:
    def __init__(self, name, department, salary):
        ...
        # Protected attribute (by convention, should not be accessed outside class/subclass)
    ...
    # Setter method to validate and set salary
...
e = Employeee("Bhargavi", "CSE", 30000)
e.show_info()
...
try:
    ...
    print("Trying to access private salary directly shows an error")
