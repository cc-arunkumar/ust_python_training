...
file_path=r"Day6\task\ust_healthcare_visits.csv"
summary_file="Day6\task\patient_summary.csv"
pending_file="Day6\task\pending_payments.csv"
...
# Pending Payments
with open(file_path,"w", newline="",encoding="utf-8") as pen_file:
...
# Patient Summary
with open(file_path,"w",newline="",encoding="utf-8") as sum_file:
