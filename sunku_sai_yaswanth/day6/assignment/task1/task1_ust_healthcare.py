...
with open("ust_healthcare_visits.csv", mode='r', newline='') as file:
...
with open("pending_payments1.csv", mode='w', newline='') as outfile:
    writer = csv.DictWriter(outfile, fieldnames=fieldnames)
    writer.writeheader()
    writer.writerows(pending_rows)

#  Write patient summary to CSV
with open("patient_summary1.csv", mode='w', newline='') as summaryfile:
    ...
    for pid, data in patient_summary.items():
        writer.writerow({'patient_id': pid,'name': data['name'],'total_visits': data['total_visits'],
            'total_billed': f"{data['total_billed']:.2f}",'has_pending': 'Yes' if data['has_pending'] else 'No'})
...
print("Pending payments:", len(pending_rows))  
...
# P002, Riya Sharma, 2025-10-02, 12000.0, Pending
# P003, John Doe, 2025-10-02, 3500.0, Unpaid
# P004, Meena Patel, 2025-10-03, 2200.0, Paid
# P005, Suresh K, 2025-10-03, 1800.0, Pending
# P006, Neha Verma, 2025-10-04, 4800.5, Paid
# P007, Alex Johnson, 2025-10-04, 6000.0, Pending
...
# P013, Olga Petrova, 2025-10-07, 4200.0, Unpaid
# P014, Diego Marquez, 2025-10-08, 7000.0, Paid
# P015, Ananya Rao, 2025-10-08, 1100.0, Pending
# P016, Sunil Sharma, 2025-10-09, 8200.0, Paid
...
# P023, Sana Khan, 2025-10-12, 3200.0, Paid
# P024, Raj Patel, 2025-10-12, 4100.0, Pending
...
# P029, Liu Chen, 2025-10-15, 5200.0, Pending
# P030, Mira Kapoor, 2025-10-15, 3000.0, Unpaid
...
# P040, Rachel Adams, 2025-10-20, 4100.0, Pending
...
# P052, Priya Menon, 2025-10-24, 2700.0, Pending
...
# P060, Ayesha Khan, 2025-10-26, 4200.0, Paid
