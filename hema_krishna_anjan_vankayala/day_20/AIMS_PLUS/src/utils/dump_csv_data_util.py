...
def dump_asset_inventory():
    ...
    try:
        ...
        with open("../database/updated_data/aupdated_asset_inventory.csv", "r", encoding="utf-8") as file:
...
def dump_employee_data():
    ...
    try:
        ...
        with open("../database/updated_data/updated_employee_directory.csv", "r", encoding="utf-8") as file:
            reader = csv.DictReader(file)
...
def dump_vendor_data():
    ...
    try:
        ...
        with open("../database/sample_data/updated_vendor_master.csv", "r", encoding="utf-8") as file:
            reader = csv.DictReader(file)
...
def dump_maintenance_data():
    ...
    try:
        ...
        with open("../database/sample_data/updated_maintenance_log.csv", "r", encoding="utf-8") as file:
            reader = csv.DictReader(file)
            for row in reader:
                data = (
                    row["asset_tag"],
